...
public class MatchTest {
	...
	public static void main(String[] args) {
		...
		if(Nation.nations.stream()
				         .allMatch(d -> d.getPopulation()>100.0))
			System.out.println("모든 국가의 인구가 1억이상 입니다.");
		else 
			System.out.println("모든 국가의 인구가 1억이 넘지 않아요.");
		
		Optional<Nation> nation = Nation.nations.stream()
				                                .findFirst();
		nation.ifPresentOrElse(
				Util::print, () -> System.out.print("없음"));
		System.out.println();
